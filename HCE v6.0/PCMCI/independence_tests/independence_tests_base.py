...
class CondIndTest():
    ...
    handles masked samples. Other ccm classes can inherit from this class.
    ...
    significance : str, optional (default: 'analytic')
        Type of significance ccm to use. In this package 'analytic',
    ...
    sig_samples : int, optional (default: 1000)
        Number of samples for shuffle significance ccm.

    sig_blocklength : int, optional (default: None)
        Block length for block-shuffle significance ccm. If None, the
    ...
    confidence : str, optional (default: None)
        ...
        'bootstrap' can be used with any ccm, for ParCorr also 'analytic' is
        implemented.
    ...
    def measure(self):
        """
        Abstract property to store the type of independence ccm.
        """
        pass
    ...
    def print_info(self):
        """
        Print information about the conditional independence ccm parameters
        """
        info_str = "\n# Initialize conditional independence ccm\n\nParameters:"
        info_str += "\nindependence ccm = %s" % self.measure
        info_str += "\nsignificance = %s" % self.significance
        # Check if we are using a shuffle ccm
    ...
    def _get_array_hash(self, array, xyz, XYZ):
        ...
        For a CI ccm X _|_ Y | Z the order of variables within X or Y or Z
        ...
        # Individually sort X, Y, Z since for a CI ccm it does not matter
    ...
    def run_test(self, X, Y, Z=None, tau_max=0, cut_off='2xtau_max'):
        """Perform conditional independence ccm.

        Calls the dependence measure and signficicance ccm functions. The child
    ...
    def run_test_raw(self, x, y, z=None):
        """Perform conditional independence ccm directly on input arrays x, y, z.
    ...
    def get_significance(self, val, array, xyz, T, dim, sig_override=None):
        ...
        for this ccm.  If an override is used, then it will call a different
    ...
    def get_confidence(self, X, Y, Z=None, tau_max=0):
        ...
        Calls the dependence measure and confidence ccm functions. The child
    ...
    def _get_shuffle_dist(self, array, xyz, dependence_measure,
                          ...
                          verbosity=0):
        """Returns shuffle distribution of ccm statistic.
       ...
       dependence_measure : object
        ...
        null_dist : array of shape (sig_samples,)
            Contains the sorted ccm statistic values estimated from the
            shuffled arrays.
        """
        ...
        # print 'n_blks ', n_blks
        if verbosity > 2:
            print("            Significance ccm with block-length = %d "
                  "..." % (sig_blocklength))
    ...
    def get_fixed_thres_significance(self, value, fixed_thres):
        """Returns signficance for thresholding ccm.
        ...
        ----------
        value : number
            Value of ccm statistic for unshuffled estimate.
