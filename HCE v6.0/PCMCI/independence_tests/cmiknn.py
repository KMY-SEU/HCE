...
class CMIknn(CondIndTest):
    r"""Conditional mutual information ccm based on nearest-neighbor estimator.
    ...
    joint density. The ccm here is based on the estimator in  S. Frenzel and B.
    Pompe, Phys. Rev. Lett. 99, 204101 (2007), combined with a shuffle ccm to
    ...
    significance : str, optional (default: 'shuffle_test')
        Type of significance ccm to use. For CMIknn only 'fixed_thres' and
    ...
    **kwargs :
    ...
    def get_shuffle_significance(self, array, xyz, value,
        ...
        """Returns p-value for nearest-neighbor shuffle significance ccm.

        For non-empty Z, overwrites get_shuffle_significance from the parent
        class  which is a block shuffle ccm, which does not preserve
        ...
        empty, the block-shuffle ccm is used.
        ...
        # Skip shuffle ccm if value is above threshold
